...
funding: Vingroup Innovation Foundation (VINIF)
project_number: VINIF.2025.DA096
role: Scientific Secretary
---

**Development of unmanned subterranean vehicles with an onboard manipulator for underground environment exploration**

- **Duration:** Dec. 2025 – Present
- **Funding source:** Vingroup Innovation Foundation (VINIF)
- **Project number:** VINIF.2025.DA096
- **Role:** Scientific Secretary
...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/vinif-subterranean-vehicle.png" title="Unmanned subterranean vehicle with onboard manipulator" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

## Related publications

I am an author on each of the publications below, reflecting my contributions to this project.

<div class="publications">
{% bibliography --query @*[key=le2026adaptivevelocitysensorless] %}
{% bibliography --query @*[key=le2026cascadefixedtime] %}
{% bibliography --query @*[key=le2026robustfixedtimefaulttolerant] %}
</div>
