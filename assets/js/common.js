  ...
  if (tocSidebar) {
    ...
    if (window.tocbot && typeof window.tocbot.init === "function" && headings.length > 0) {
      ...
      window.tocbot.init({
        ...
        scrollSmooth: true,
        // Matches the fixed navbar's clearance (see _sass/_typography.scss's
        // scroll-margin-top / #toc-sidebar top overrides) — the gem default of 80
        // left headings tucked partly under the navbar when jumped to.
        scrollSmoothOffset: -104,
        headingsOffset: 104,
      });
